...
<table class="table table-light table-responsive" width="100" id="data">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php if($books->sum('status',1) < 1): ?> 0 <?php else: ?> <?php echo e($books->sum('status',1)); ?> <?php endif; ?></td> <td>
                    <?php echo e($books->count() - $books->sum('status',1)); ?></td>
            <td>
...
</table><?php /**PATH /Users/muhamadfikri/Developer/Project/dev-omobv2/resources/views/exports/adminreport.blade.php ENDPATH**/ ?>