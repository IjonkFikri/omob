...
if (isset($messageCache)) { $message = $messageCache; }
            ...
            <optgroup label="<?php echo e($unit->nama_unit); ?>">
                ...
                <option value="<?php echo e($level->id); ?>" <?php echo e($students->kelas_id ==$level->id ?'selected':''); ?>><?php echo e($level->nama_kelas); ?></option>
...
$message = $errors->first('kelas_id'); ?>
    ...
    <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?><?php /**PATH /home/nuru8354/public_html/omobv2/resources/views/inc/form/_formStudentClassEdit.blade.php ENDPATH**/ ?>