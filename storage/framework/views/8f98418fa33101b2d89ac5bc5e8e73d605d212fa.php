    ...
    <tbody>
        ...
        <tr>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="title">
                                                <?php $reading = $readings->where('books_id',$book->id)->where('users_id',$student->users_id)->where('kelas_id',$student->kelas_id); ?>
                                                    <?php echo e($reading->sum('total_baca')); ?>

                                            </td>
                                            <td class="title text-primary">
                                                <?php echo e(round(($reading->sum('total_baca')/$book->jumlah_halaman)*100)); ?>
            ...
            <td class="td1 title text-center">
                <?php $cReview = $review->whereIn('books_id',$books->pluck('id')) ?>
                <?php echo e($cReview->count('books_id')); ?>

            </td> 
            
            <td class="td1 title text-center">
                <?php echo e($books->count('judul_buku') - $cReview->count('books_id')); ?></td>
            <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhamadfikri/Developer/Project/dev-omobv2/resources/views/reports/index.blade.php ENDPATH**/ ?>