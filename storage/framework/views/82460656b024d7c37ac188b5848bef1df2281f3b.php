    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                    ...
                    <a href="<?php echo e(route('books.edit',$book->id)); ?>" class="btn-text"><i
                            class="fas fa-pencil-alt text-info"></i> Edit</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nuru8354/public_html/omobv2/resources/views/books/index.blade.php ENDPATH**/ ?>