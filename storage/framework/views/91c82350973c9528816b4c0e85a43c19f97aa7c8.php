        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm card mx-1 my-1">
                    ...
                    <div class="my-4">
                        <h2> <?php echo e($student->count()); ?><h2>
                    </div>
                ...
                <div class="col-sm card mx-1 my-1">
                    ...
                    <div class="my-4">
                        <h2>
                            <?php $cReview = $review->whereIn('books_id',$book->pluck('id')) ?>
                    ...
                    <div class="col-sm card mx-1 my-1">
                        ...
                        <div class="my-4">
                            <h2>
                                <?php echo e($book->count('judul_buku') - $cReview->count('books_id')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nuru8354/public_html/omobv2/resources/views/dashboard/teacher.blade.php ENDPATH**/ ?>