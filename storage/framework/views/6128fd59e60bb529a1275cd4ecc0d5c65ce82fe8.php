...
endif; ?>" placeholder="Sinopsis"><?php echo e(old('judul_halaman')); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="Kelebihan Buku"><?php echo e(old('judul_halaman')); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="Kekurangan"><?php echo e(old('judul_halaman')); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="Kesimpulan"><?php echo e(old('judul_halaman')); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
            ...
            </div><?php /**PATH C:\devmufik\htdocs\omobv2\resources\views/inc/form/_formReview.blade.php ENDPATH**/ ?>