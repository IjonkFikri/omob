      ...
      <table class="table table-borderles" id="data">
        ...
        <tbody>
            ...
            <td>
                ...
                <td>
                <a href="<?php echo e(route('review.show',['id'=>$data->users_id,'lv'=>$data->kelas_id])); ?>" class="btn btn-link text-decoration-none btn-txt">View Detail</a>
                </td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\devmufik\htdocs\omobv2\resources\views/review/index.blade.php ENDPATH**/ ?>