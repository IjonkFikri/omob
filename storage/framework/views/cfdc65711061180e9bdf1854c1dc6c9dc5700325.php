    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <?php echo csrf_field(); ?>
                <?php if(($book->jumlah_halaman == $readings->sum('total_baca')) && ($review->where('books_id',$book->id)->count()  >= 1)): ?>
                <i class="fas fa-check-circle text-success"></i> <span class="btn-text">Selesai</span>
                <?php elseif(($review->where('books_id',$book->id)->count() == 0) && ($book->jumlah_halaman == $readings->sum('total_baca'))): ?>
                <!-- Button trigger modal -->
                <a href="#" data-toggle="modal" data-target="#modelId" class="btn-text"><i class="far fa-clipboard"></i> Review</a>
                <!-- Modal -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nuru8354/public_html/omobv2/resources/views/readings/index.blade.php ENDPATH**/ ?>