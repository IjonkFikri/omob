    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="td1 title text-center">
                ...
                <?php echo e($review->whereIn('books_id',$book->pluck('id'))->count()); ?>

                
            </td> 
            <td class="td1 title text-center">
                <?php echo e($book->count('books_id') - $review->whereIn('books_id',$book->pluck('id'))->count()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhamadfikri/Developer/Project/dev-omobv2/resources/views/reports/recap.blade.php ENDPATH**/ ?>