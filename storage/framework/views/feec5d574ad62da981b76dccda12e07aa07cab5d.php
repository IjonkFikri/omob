...
if (isset($messageCache)) { $message = $messageCache; }
            ...
            <optgroup label="<?php echo e($unit->nama_unit); ?>">
                ...
                <option value="<?php echo e($level->id); ?>" <?php echo e($level->id == $students->kelas_id ? 'selected' : ''); ?>><?php echo e($level->nama_kelas); ?></option>
...
$message = $errors->first('kelas_id'); ?>
    ...
    <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?><?php /**PATH C:\devmufik\htdocs\omobv2\resources\views/inc/form/_formStudentEdit.blade.php ENDPATH**/ ?>