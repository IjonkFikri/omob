<?php if($students->count() <= 1): ?> <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <input type="hidden" name="kelas_id"
    value="<?php echo e($student->kelas_id); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
            ...
            <option value="<?php echo e($student->kelas_id); ?>" <?php echo e(old('kelas_id')==$student->id ?'selected':''); ?>>
                <?php echo e($student->level->nama_kelas); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
...
if (isset($messageCache)) { $message = $messageCache; }
    ...
    <div class="form-group">
        ...
        <input type="number" name="jumlah_halaman" id=""
            class="form-control <?php if ($errors->has('jumlah_halaman')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('jumlah_halaman'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="Jumlah Halaman"
            value="<?php echo e(old('jumlah_halaman')); ?>" autocomplete="off">
...
if (isset($messageCache)) { $message = $messageCache; }
    ...
    <div class="form-group">
        ...
        <textarea name="judul_buku" id="" cols="30" rows="4"
            class="form-control <?php if ($errors->has('judul_buku')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('judul_buku'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>"
            placeholder="Judul Buku Bacaan"><?php echo e(old('judul_halaman')); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
    ...
    </div><?php /**PATH /Users/muhamadfikri/Developer/Project/dev-omobv2/resources/views/inc/form/_formBookCreate.blade.php ENDPATH**/ ?>