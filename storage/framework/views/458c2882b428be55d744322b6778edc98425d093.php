...
<h4><?php echo e($books->judul_buku); ?></h4>
...
endif; ?>" placeholder="Sinopsis"><?php echo e($books->sinopsis ?? old('sinopsis')); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="Kelebihan Buku"><?php echo e($books->kelebihan ?? old('kelebihan')); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="Kekurangan"><?php echo e($books->kekurangan ?? old('kekurangan')); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="Kesimpulan"><?php echo e($books->kesimpulan ?? old('kesimpulan')); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
            ...
            </div><?php /**PATH /home/nuru8354/public_html/omobv2/resources/views/inc/form/_formReviewEdit.blade.php ENDPATH**/ ?>