        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm card mx-1 my-1">
                    ...
                    <div class="my-4">
                        <h2>
                            @if($books->sum('status',1) < 1) 0 @else {{$books->sum('status',1)}} @endif </h2> </div> <p
                    ...
                    <div class="col-sm card mx-1 my-1">
                        ...
                        <div class="my-4">
                            <h2>
                                {{$books->count('judul_buku') - $books->sum('status',1)}}
                            </h2>
                        </div>
                    ...
                    <table class="table table-borderless table-responsive table-hover bg-white" style="width:100%;">
                        ...
                        <tbody style="text-align: center; font-family: 'Nunito Sans', sans-serif; font-weight:bold;">
                            ...
                            <tr>
                                ...
                                <td style="width:10%;">
                                    {{$booksTotal->count() - $booksFinish->count()}}
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
